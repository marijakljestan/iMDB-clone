...
VALUES (nextval('actor_seq_gen'), '../../../assets/images/actors/marlon-brando.jpg',        'Marlon Brando'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/al-pacino.jpg',            'Al Pacino'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/robert-deniro.jpg',        'Robert De Niro'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/christian-bale.jpg',       'Christian Bale'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/heath-ledger.jpg',         'Heath Ledger'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/brad-pitt.jpg',            'Brad Pitt'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/edward-norton.jpg',        'Edward Norton'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/leonardo-dicaprio.jpg',    'Leonardo DiCaprio'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/joseph-gordonlevitt.jpg',  'Joseph Gordon-Levitt'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/john-travolta.jpg',        'John Travolta'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/uma-thurman.jpg',          'Uma Thurman'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/samuel-ljackson.jpg',      'Samuel L. Jackson'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/bruce-willis.jpg',         'Bruce Willis'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/roberto-benigni.jpeg',     'Roberto Benigni'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/nicoletta-braschi.jpg',    'Nicoletta Braschi'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/liam-neeson.jfif',         'Liam Neeson'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/ralph-fiennes.jpg',        'Ralph Fiennes'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/joaquin-phoenix.jpg',      'Joaquin Phoenix'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/tim-robbins.jpg',          'Tim Robbins'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/morgan-freeman.jfif',      'Morgan Freeman'),
       (nextval('actor_seq_gen'), '../../../assets/images/actors/emily-mortimer.JPG',       'Emily Mortimer');
