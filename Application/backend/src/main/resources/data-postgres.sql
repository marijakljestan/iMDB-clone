...
VALUES (nextval('actor_seq_gen'), 'Marlon', '../../../assets/images/actors/marlon-brando.jpg', 'Brando'),
       ...
       (nextval('actor_seq_gen'), 'Christian', '../../../assets/images/actors/christian-bale.jpg', 'Bale'),
       (nextval('actor_seq_gen'), 'Heath', '../../../assets/images/actors/heath-ledger.jpg', 'Ledger'),
       (nextval('actor_seq_gen'), 'Brad', '../../../assets/images/actors/brad-pitt.jpg', 'Pitt'),
       (nextval('actor_seq_gen'), 'Edward', '../../../assets/images/actors/edward-norton.jpg', 'Norton'),
       (nextval('actor_seq_gen'), 'Leonardo', '../../../assets/images/actors/leonardo-dicaprio.jpg', 'DiCaprio'),
       (nextval('actor_seq_gen'), 'Joseph', '../../../assets/images/actors/joseph-gordonlevitt.jpg', 'Gordon-Levitt'),
       (nextval('actor_seq_gen'), 'John', '../../../assets/images/actors/john-travolta.jpg', 'Travolta'),
       (nextval('actor_seq_gen'), 'Uma', '../../../assets/images/actors/uma-thurman.jpg', 'Thurman'),
       (nextval('actor_seq_gen'), 'Samuel', '../../../assets/images/actors/samuel-ljackson.jpg', 'L. Jackson'),
       (nextval('actor_seq_gen'), 'Bruce', '../../../assets/images/actors/bruce-willis.jpg', 'Willis'),
       (nextval('actor_seq_gen'), 'Roberto', '../../../assets/images/actors/roberto-benigni.jpeg', 'Benigni'),
       (nextval('actor_seq_gen'), 'Nicoletta', '../../../assets/images/actors/nicoletta-braschi.jpg', 'Braschi'),
       (nextval('actor_seq_gen'), 'Liam', '../../../assets/images/actors/liam-neeson.jfif', 'Neeson'),
       (nextval('actor_seq_gen'), 'Ralph', '../../../assets/images/actors/ralph-fiennes.jpg', 'Fiennes'),
       (nextval('actor_seq_gen'), 'Joaquin', '../../../assets/images/actors/joaquin-phoenix.jpg', 'Phoenix'),
       (nextval('actor_seq_gen'), 'Tim', '../../../assets/images/actors/tim-robbins.jpg', 'Robbins'),
       (nextval('actor_seq_gen'), 'Morgan', '../../../assets/images/actors/morgan-freeman.jfif', 'Freeman'),
       (nextval('actor_seq_gen'), 'Emily', '../../../assets/images/actors/emily-mortimer.JPG', 'Mortimer');
...
VALUES (nextval('crew_member_seq_gen'), 'Mario', 'Puzo'),
       ...
       (nextval('crew_member_seq_gen'), 'Scott', 'Silver'),
       (nextval('crew_member_seq_gen'), 'Frank', 'Darabont'),
       (nextval('crew_member_seq_gen'), 'Martin', 'Scorsese'),
       (nextval('crew_member_seq_gen'), 'Stephen', 'King'),
       (nextval('crew_member_seq_gen'), 'Laeta', 'Kalogridis');
...
VALUES (nextval('role_seq_gen'), 'Don Vito Corleone', 1, 1),
       ...
       (nextval('role_seq_gen'), 'Murray Franklin', 3, 8),
